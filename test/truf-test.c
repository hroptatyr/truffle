/*** truf-test.c -- just to work around getopt issues in truf-test.sh */
...
main(int argc, char *argv[])
{
	...
	/* build the command */
	{
		static const char fn[] = "truf-test.sh";
		static char buf[4096];
		size_t idx = 0UL;
	...
	{
		char *const new_argv[] = {"truf-test.sh", shpart, NULL};
